...
vim.keymap.set('n', '<leader>sf', ':LiveGrepGitRoot<cr>', { desc = '[S]earch by [G]rep on Git Root' })
vim.keymap.set('n', '<leader>s<space>', telescope_live_grep_open_files, { desc = '[S]earch [/] in Open Files' })
